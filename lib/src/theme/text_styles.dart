...
class FontSizes {
  ...
  static double get sizeXXl => 18 * scale;
}
...
class TextStyles {
  ...
  static TextStyle get titleNormal =>
      title.copyWith(fontWeight: FontWeight.w500,fontFamily: "opensans");
  static TextStyle get titleMedium =>
      titleM.copyWith(fontWeight: FontWeight.w300);
  static TextStyle get h1Style =>
      TextStyle(fontSize: FontSizes.sizeXXl, fontWeight: FontWeight.bold,fontFamily: "opensans");
